...
import com.example.testinterface.dummy.DummyContent;

import java.util.List;

/**
 * An activity representing a list of Bulidings. This activity
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(BuildingDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(BuildingDetailFragment.ARG_ITEM_ID, holder.mItem.id);
